...
void render () { 
  ...
  glPushMatrix(); /* Encapsulamos la rotacion interna de la tierra */
  ...
  glPopMatrix();  /* Encapsulamos la rotacion interna de la tierra */
  glPushMatrix(); /* Encapsulamos los movimientos de la luna roja */
  ...
  glPopMatrix(); /* Encapsulamos los movimientos de la luna roja */
